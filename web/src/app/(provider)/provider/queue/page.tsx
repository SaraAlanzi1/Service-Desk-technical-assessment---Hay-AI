...
function TicketRow({
  ...
  return (
    <>
      <tr className="border-b border-brand-border align-top transition-colors hover:bg-brand-cream/60">
        ...
        <td className="py-2.5 text-brand-primary/70">{row.data.submittedAt.toDate().toLocaleString()}</td>
        <td className="py-2.5">{row.data.unit}</td>
        <td className="py-2.5">
...
export default function ProviderQueuePage() {
  ...
  return (
    <main className="mx-auto max-w-5xl p-8">
      ...
      <Card className="mt-4">
        {rows.length === 0 ? (
          <p className="py-6 text-center text-sm text-brand-primary/50">No tickets.</p>
        ) : (
